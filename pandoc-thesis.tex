...
\begin{titlepage}
\large
{\def\baselinestretch{1.2}\Large\bf $thesistitle$ \par}
by\par
{\Large $thesisauthor$}\par
$prevdegrees$\par\vspace{1em}
...
$if(copyrightauthor)$
\copyright\ $thesisauthor$ $degreeyear$. All rights reserved. \permission \par
$else$
\copyright\ Massachusetts Institute of Technology $degreeyear$. All rights reserved.\par
$endif$
\vskip 3\baselineskip
\signature{Author}{$department$ \\ $thesisdate$}\par\vfill
\signature{Certified by}{$supervisor$ \\ $supervisortitle$ \\ Thesis Supervisor}\par\vfill
\signature{Accepted by}{$chair$ \\ $chairtitle$}\vfill
\end{titlepage}
%

% Thesis format -- abstract page
\cleardoublepage
\begin{center}{\large{\bf $thesistitle$} \\[\baselineskip]
by \\[\baselineskip]
$thesisauthor$ \\[2\baselineskip]}
\par
% \def\baselinestretch{1}\normalsize
Submitted to the $department$ \\
on $thesisdate$, in partial fulfillment of the requirements \\
...
\noindent
\vskip\baselineskip
Thesis Supervisor: $supervisor$ \\ Title: $supervisortitle$
% \newpage
%
